...
export class PhoneverPage {
 ...
 loading:Loading;
  ...
  sendotp(otp,user){
    ...
    this.http.get('http://cloud.smsindiahub.in/vendorsms/pushsms.aspx?user=abmnu_kmr&password=Arjunsingh1$&msisdn='+this.registerForm.value.phone+'&sid=VAIOTI&msg=Dear user, VAIOTI welcomes you. Now you proceed with this OTP '+otp+'.&fl=0&gwid=2').subscribe((res) => {
