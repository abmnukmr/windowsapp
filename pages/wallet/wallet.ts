...
//              errror=2;
  ...
  deleteReview(id) {
    ...
    this.http.get('https://vaiotibackend.herokuapp.com/profile/email/'+this.email1+'/delete/' + id).subscribe((res) => {
