...
/**
 * Generated class for the VaiotiTextComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'vaioti-text',
  templateUrl: 'vaioti-text.html'
})
export class VaiotiTextComponent {
  ...
  private currentVaioti: string;
  @Output() VaiotiChange: EventEmitter<string> = new EventEmitter<string>();

  @Input() set Vaioti(machineItem: string) {
    this.currentVaioti= machineItem;
    this.VaiotiChange.emit(machineItem);
  }

  get Vaioti(): string {
    return this.currentVaioti;
  }
